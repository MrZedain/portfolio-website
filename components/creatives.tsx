...
const hobbies = [
  {
    ...
    description: "Shooting with vintage film cameras and developing in the darkroom.",
    videos: [
      "public/videos/bouldering/comp-orange",
      "public/videos/bouldering/pink-gray",
      "public/videos/bouldering/gray-1",
      "public/videos/bouldering/orange-gray",
      "public/videos/bouldering/blue-gray",
    ],
  },
  {
    title: "Horse riding",
...
export function Creatives() {
  ...
  return (
    <section className="min-h-screen py-5 px-3 md:px-12 lg:px-24 max-w-7xl mx-auto scroll-mt-24">
      <div className="space-y-16">
        <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {creativeWorks.map((work, workIndex) => {
            ...
            return (
              <Card
                key={workIndex}
                className="bg-card py-0 border-border overflow-hidden group hover:border-white/20 transition-colors"
              >
                <div
                  className="aspect-4/5 overflow-hidden bg-secondary cursor-pointer"
                  onClick={() => {
        ...
        <div className="pt-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {hobbies.map((hobby, index) => (
              <div
                key={index}
                className="space-y-2 p-6 border border-border hover:border-white/20 transition-colors"
              >
                <h4 className="text-lg font-semibold text-white">{hobby.title}</h4>
                <p className="text-muted-foreground leading-relaxed">{hobby.description}</p>
              </div>
